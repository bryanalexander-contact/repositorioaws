...
import "../../assets/css/checkout.css"; // reutilizamos el estilo bonito

export default function DetalleBoleta() {
  const { user } = useUsers();
  const { id } = useParams(); // id = número de compra
  ...
  // 🔹 Buscar la boleta en su historial
  const boleta = user.historialCompras?.find(
    (b) => String(b.numeroCompra) === String(id)
  );
  ...
  const { comprador, productos, total, fecha, numeroCompra } = boleta;
    ...
    <>
      ...
      <main className="container my-5">
        <div className="text-center mb-4">
          ...
          <p className="text-muted">Resumen completo de tu compra #{numeroCompra}</p>
        </div>
        ...
        <div className="border rounded shadow-sm p-4 mb-4 bg-light">
          ...
          <div className="mb-4">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <strong>Correo:</strong> {comprador?.correo}
              </div>
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <strong>Región:</strong> {comprador?.region}
              </div>
              <div className="col-md-6">
                <strong>Comuna:</strong> {comprador?.comuna}
              </div>
