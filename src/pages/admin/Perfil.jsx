  ...
  return (
    <div className="admin-container">
      <aside className="sidebar-admin">
        <h2>Panel Usuario</h2>
        <ul>
          <li><Link to="/admin/perfil" className="active">Mi Perfil</Link></li>
          <li><Link to={`/admin/editar-usuario/${user.id}`}>Editar Perfil</Link></li>
          <li><Link to={`/admin/historial-compras/${user.id}`}>Historial de Compras</Link></li>
        </ul>
      </aside>
