    ...
    <>
      ...
      <main className="checkout-container container my-5">
        <div className="checkout-header d-flex justify-content-between align-items-center mb-4 p-3 border rounded shadow-sm">
          ...
          <h4 className="mb-0 text-success fw-bold">Total: ${total.toLocaleString()}</h4>
        </div>
          ...
          <form onSubmit={handlePagar}>
            <div className="row mb-3">
              <div className="col-md-6">
                <label>Nombre</label>
                <input name="nombre" type="text" className="form-control" value={form.nombre} onChange={handleChange} />
              </div>
              <div className="col-md-6">
                <label>Apellidos</label>
                <input name="apellidos" type="text" className="form-control" value={form.apellidos} onChange={handleChange} />
              </div>
            </div>

            <label>Correo</label>
            <input name="correo" type="email" className="form-control mb-3" value={form.correo} onChange={handleChange} />

            <label>Dirección de entrega</label>
            <input name="direccion" type="text" className="form-control mb-3" placeholder="Ingrese dirección detallada" value={form.direccion} onChange={handleChange} />

            <div className="row mb-3">
              <div className="col-md-6">
                <label>Departamento (opcional)</label>
                <input name="departamento" type="text" className="form-control" value={form.departamento} onChange={handleChange} />
              </div>
              <div className="col-md-3">
                <label>Región</label>
                <input name="region" type="text" className="form-control" value={form.region} onChange={handleChange} />
              </div>
              <div className="col-md-3">
                <label>Comuna</label>
                <input name="comuna" type="text" className="form-control" value={form.comuna} onChange={handleChange} />
              </div>
            </div>

            <label>Indicaciones para la entrega (opcional)</label>
            <textarea name="indicacion" className="form-control mb-3" rows="2" value={form.indicacion} onChange={handleChange}></textarea>
